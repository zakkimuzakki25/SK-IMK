rfimport PrimerButtonSquare from '../button/square/PrimerButtonSquare'
import PropTypes from 'prop-types'
import checkIcon from '../../assets/icon/check.svg'

const ReturnInfo = ({okHandle, theDate}) => {

  return (
    <div className='flex flex-col rounded-2xl bg-white overflow-hidden'>
        <div className="py-3 bg-primary2 text-white font-semibold text-xl justify-center flex">Returning Information</div>
