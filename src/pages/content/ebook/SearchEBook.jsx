...
const SearchEBook = () => {
    ...
    return (
        <div className="flex flex-col h-screen w-screen bg-primary2 overflow-auto">
            ...
            <div className="flex flex-row">
                ...
                <div className="flex flex-col p-7 sticky gap-2">
                    ...
                    <div className="px-3 text-2xl text-white">Hasil Pencarian Untuk &quot;{searchKey}&quot;</div>
                        <div className="flex flex-row gap-3">
                            ...
                            <div className="flex flex-row justify-center mr-16 items-center text-white">atau<Link className="ml-2 text-xl text-white hover:text-teks" to={`/book/search/${searchKey}`}>Book</Link></div>
                        </div>
                    </div>
