            ...
            <div className="flex flex-row">
                ...
                <div className="flex flex-col p-7 sticky gap-2">
                    <div className="gap-4 flex flex-col px-2">
                        <div className="px-3 text-2xl text-black">Hasil Pencarian Untuk &quot;{searchKey}&quot;</div>
                        <div className="flex flex-row gap-3">
                            ...
                            <div className="flex flex-row justify-center mr-16 items-center">atau <Link className="ml-2 text-xl text-primary2 hover:text-teks" to={`/e-book/search/${searchKey}`}>E-Book</Link></div>
                        </div>
                    </div>
