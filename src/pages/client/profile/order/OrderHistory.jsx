import book from '../../../../data/profile/BookHistory.json'
import Navbar from '../../../../components/layout/Navbar'
import DataSideOrder from "../../../../data/profile/SideOrder.json"
import SideBarProfile from "../../../../components/layout/SideBarProfile"
import { Link, useLocation } from "react-router-dom"
import RateBookCard from '../../../../components/card/RateBookCard'
    ...
    return (
        <div className="flex flex-col h-screen w-screen bg-backgroundlinear overflow-hidden">
            ...
            <div className="flex flex-row h-full">
                ...
                {/* content right*/}
                <div className="flex flex-wrap py-10 pb-32 gap-5 overflow-y-auto pr-12">
                    {book.map((e) => (
                        <RateBookCard key={e.id} title={e.title} pic={e.pic} rate={e.rate} tot_review={e.tot_review} />
                    ))}
                </div>
